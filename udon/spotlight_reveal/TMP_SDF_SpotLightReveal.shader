...
Shader "Lereldarion/TMP_SDF_SpotLightReveal" {
...
SubShader {
	...
	Pass {
		...
		struct pixel_t {
			...
			float3 position_ws : POSITION_WS; // SpotLightReveal
		};
		...
		pixel_t VertShader(vertex_t input)
		{
			...
			output.position_ws = mul(unity_ObjectToWorld, vert).xyz; // SpotLightReveal
			return output;
		}
